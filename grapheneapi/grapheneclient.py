...
from .graphenewebsocket import GrapheneWebsocket
...
class GrapheneClient() :
    ...
    def __init__(self, config):
        ...
        if self.core_asset["symbol"] == "BTS" :
            ...
            self.prefix = "GPH"
        elif self.core_asset["symbol"] == "ONE" :
            self.prefix = "ONE"
